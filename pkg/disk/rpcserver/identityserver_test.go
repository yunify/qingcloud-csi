...
func newFakeIdentityServer(t *testing.T, ddcfg *driver.InitDiskDriverInput, cmcfg *mock.MockCloudManager) *IdentityServer {
	diskDriver := driver.GetDiskDriver()
	diskDriver.InitDiskDriver(ddcfg)
	return NewIdentityServer(diskDriver, cmcfg)
}
